...
# Preprocess the data for LSTM (Updated)
def preprocess_data(data):
    # Select the relevant features
    data = data[['ph', 'turbidity', 'hardness', 'solids', 'conductivity', 'organic_carbon']]

    # Standardize the data (fit scaler on all data)
...
def predict_potability(data, model):
    ...
    # Preprocess data and get scaler
    sequence, scaler = preprocess_data(data)
        ...
        with placeholder.container():
            ...
            if not data.empty:
                ...
                if not prediction_df.empty:
                    ...
                    st.line_chart(prediction_df.set_index('timestamp')['potability'], use_container_width=True)
